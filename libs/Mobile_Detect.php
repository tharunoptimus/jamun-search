<?php
/**This Source Code was downloaded from the Internet from unknown source - This source is known to detect
 * the device specification like the user agent is mobile or desktop so that the jamun search engine
 * intelligently switches the rules of the style sheet data to fit in those devices for apt usage**/
